...
public:
	...
	static std::shared_ptr<frc::Compressor> compressor20;
	static std::shared_ptr<frc::DoubleSolenoid> driveTrainShifterDoubleSolenoidLeft;
	static std::shared_ptr<frc::DoubleSolenoid> driveTrainShifterDoubleSolenoidRight;

	static std::shared_ptr<WPI_TalonSRX> elevatorTalonSRX7;
	static std::shared_ptr<WPI_TalonSRX> elevatorTalonSRX8;
	static std::shared_ptr<WPI_TalonSRX> armTalonSRX9;
