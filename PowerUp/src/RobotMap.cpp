...
//std::shared_ptr<frc::SpeedControllerGroup> RobotMap::elevatorElevatorSpeedControllerGroup;
...
void RobotMap::init() {
    ...
    //driveTrainTalonSRX3->Config_kP(3, 0.2, 1);
    //driveTrainTalonSRX3->ConfigOpenloopRamp(0.5, 10);
    driveTrainTalonSRX3->Follow(*driveTrainTalonSRX1);

    driveTrainTalonSRX5.reset(new WPI_TalonSRX(5));
    //driveTrainTalonSRX5->Config_kP(5, 0.2, 1);
    //driveTrainTalonSRX5->ConfigOpenloopRamp(0.5, 10);
    ...
    //driveTrainTalonSRX4->Config_kP(4, 0.2, 1);
    //driveTrainTalonSRX4->ConfigOpenloopRamp(0.5, 10);
    driveTrainTalonSRX4->Follow(*driveTrainTalonSRX2);

    driveTrainTalonSRX6.reset(new WPI_TalonSRX(6));
    //driveTrainTalonSRX6->Config_kP(6, 0.2, 1);
    //driveTrainTalonSRX6->ConfigOpenloopRamp(0.5, 10);
    ...
    elevatorTalonSRX8.reset(new WPI_TalonSRX(8));
    

    /*elevatorElevatorSpeedControllerGroup = std::make_shared<frc::SpeedControllerGroup>(*elevatorTalonSRX7, *elevatorTalonSRX8  );
    lw->AddActuator("Elevator", "Elevator Speed Controller Group", );*/

    armTalonSRX9.reset(new WPI_TalonSRX(9));
