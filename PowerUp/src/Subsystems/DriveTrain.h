...
public:
	...
	constexpr static double highGgearRatio = 15.0 / 1.0;
	constexpr static double highGgearEncoderRatio = lowGgearRatio * (12.0 / 30.0);
...
//	constexpr static double nativeUnitsPerMeterHighGear = 1 / wheelCircumference * lowGgearEncoderRatio * sensorUnitsPerRev;
	constexpr static double nativeUnitsPerMeterHighGear = 13659; // approx
