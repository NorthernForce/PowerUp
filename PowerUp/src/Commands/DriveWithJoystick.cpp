...
void DriveWithJoystick::Execute()
{
	...
	if (driveStick == 0) {*/
		RobotMap::driveTrainRobotDrive->ArcadeDrive(driverController->GetY(frc::XboxController::JoystickHand::kLeftHand), driveDirection * driverController->GetX(frc::XboxController::JoystickHand::kRightHand), true);
