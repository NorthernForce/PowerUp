...
void Robot::TeleopPeriodic() {
	...
	if (joystick->GetRawButton(1) == 1) {
		printf("made it to if with A");
		fflush(stdout);
		RobotMap::driveTrainShifterDoubleSolenoidLeft->Set(frc::DoubleSolenoid::Value::kForward);
		RobotMap::driveTrainShifterDoubleSolenoidRight->Set(frc::DoubleSolenoid::Value::kReverse);

	}

	if (joystick->GetRawButton(2) == 1) {
		printf("made it to if with B");
		fflush(stdout);
		RobotMap::driveTrainShifterDoubleSolenoidLeft->Set(frc::DoubleSolenoid::Value::kReverse);
		RobotMap::driveTrainShifterDoubleSolenoidRight->Set(frc::DoubleSolenoid::Value::kForward);
