...
//					}
//					// right
//					else if (center.x > c*22) {
////						RobotMap::driveTrainRobotDrive->ArcadeDrive(0, (float)(center.x-c*20)/(float)(c*10), true);
//					}
					if (center.x < c*18 || center.y < c*22) {
						visionAngle = (float)(center.x-c*20)/(float)(c*20);
						// maybe "0" is 0.5 (0 - 1 instead of -1 to 1)
						// visionAngle = (float)(center.x-c*20)/(float)(c*40)+0.5;
					}
					else {
						visionAngle = 0;
					}
