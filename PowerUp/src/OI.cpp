...
OI::OI() {
    ...
    frc::SmartDashboard::PutData("Move arm to climb setup", new PositionArm(PositionArm::Position::Climb));
    frc::SmartDashboard::PutData("Climb using arm and elevator", new RobotClimb());
...
//    frc::SmartDashboard::PutData()
    ...
    WhenPressed(manipulatorJoystick, 4, new PositionArm(PositionArm::Position::Climb));
    //TODO: Robot climb execute, manipulatorJoystick button 5
    WhenPressed(manipulatorJoystick, 5, new RobotClimb());
