...
std::shared_ptr<frc::Solenoid> RobotMap::gripperIntakeSolenoid;
...
bool RobotMap::rightEncoderBroke = false;
bool RobotMap::leftEncoderBroke = false;
...
void RobotMap::init() {
    ...
    gripperIntakeSolenoid.reset(new frc::Solenoid(4));
